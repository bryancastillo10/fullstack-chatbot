    ...
    <div className="flex gap-x-2 w-[95%] mx-auto items-center px-2 py-3">
      ...
      <div className="grid grid-cols-1">
        <h1 className="text-xl font-semibold">
          {parameterValue} <span className="font-base text-sm">{unit}</span>
        </h1>
...
const Weather = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-2 w-full green-gradient text-primary p-2 rounded-t-lg shadow-md">
      {weatherData ? (
        <>
          ...
          <form
            ...
            className="grid grid-cols-1 w-fit items-center gap-4"
          >
