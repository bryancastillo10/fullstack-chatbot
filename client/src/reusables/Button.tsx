...
const Button = ({
  ...
  const getBtnStyle = (variant: string) => {
    switch (variant) {
      case "primary":
        return "border border-transparent bg-secondary text-primary hover:bg-secondary/80";
      case "outline":
        return "border text-secondary border-secondary  hover:bg-secondary hover:text-primary";
      default:
