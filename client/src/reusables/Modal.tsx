                            ...
                            <div className="flex flex-col gap-2 p-6">
                                <div className="flex flex-row items-center gap-4 w-full">
                                    {secondaryAction && secondaryActionLabel && (
                                        <Button type="button"  variant="outline"  action={handleSecondaryAction}>{secondaryActionLabel}</Button>
                                    )}
                                        <Button type="button" variant="primary" action={handleSubmit}>{actionLabel}</Button>
                                </div>
                                {footer}
                            </div>
                        </div>
