...
export const appointmentApi = createApi({
    ...
    endpoints: (builder) => ({
        ...
        updateAppointment: builder.mutation<UpdateAppointment,{
            appointment_id:string;  appointmentData: AppointmentRequest}>
        ({
        ...
        deleteAppointment: builder.mutation<DeleteAppointment, {
            appointment_id:string; appointmentData: AppointmentRequest}>
        ({
            query:({appointment_id, appointmentData}) => ({
