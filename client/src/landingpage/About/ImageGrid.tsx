...
const ImageGrid = ({images}:ImageGridProps) => {
  return ( 
    ...
    lg:mt-0 grid grid-cols-2 xl:grid-cols-3 gap-2 xl:gap-4 order-1 lg:order-2">
        ...
        <div className="col-span-1 row-span-4 ">
            <img src={images[2]} alt={`${images[2]}-path`} className="w-full xl:mx-auto xl:w-fit lg:h-full "  />
        </div>
    </section>
  )
}
