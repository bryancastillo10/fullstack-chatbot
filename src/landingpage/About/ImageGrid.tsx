...
const ImageGrid = ({images}:ImageGridProps) => {
  return ( 
    <section className="mt-16 p-10 items-stretch  
    lg:mt-0 grid grid-cols-2 lg:grid-cols-3 gap-4 order-1 lg:order-2">
        ...
        <div className="col-span-1 row-span-4">
            <img src={images[2]} alt={`${images[2]}-path`} className="w-[80%] xl:w-fit lg:h-full "  />
        </div>
    </section>
  )
}
